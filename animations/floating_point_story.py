...
def render_scene():
    ...
    parser = argparse.ArgumentParser(description="Render the FloatingPointStory Manim scene.")
    parser.add_argument(
        "--scene",
        choices=["FloatingPointStory", "VendingMachineDFD", "all"],
        default="FloatingPointStory",
        help="Scene class to render.",
    )
    parser.add_argument(
        "--quality",
